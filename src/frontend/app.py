...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # unfortunately this doest give the correct screen measurements on windows
        ...
        # switch to 0 and uncomment/change the comment above to automatically load the inputs
    ...
    def clear_window(self):
        ...
        self.filename1 = ""
        self.first_frame.fname = ""
        self.filename2 = ""
        self.second_frame.fname = ""
        self.srtfilename = ""
        self.first_frame.srt_fname = ""
        self.second_frame.srt_fname = ""
        self.srtfilename2 = ""
