...
def dtw_appr(file1, file2, amp=0.25):
    """Calculates the DTW path between input signals using MFCCs and FastDTW"""
    ...
    print(normalized_frames1.shape, normalized_frames2.shape)
    ...
    print(mfccs1.shape, mfccs2.shape)
...
if __name__ == "__main__":
    ...
    file1 = "C:/Users/pewdi/Desktop/BP/example/example.wav"
    file2 = "C:/Users/pewdi/Desktop/BP/example/example_trim.wav"
